...
public class ExtendsMain01 {
	...
	public static void main(String[] args) {
		...
		Employee e5 = new Employee("고길동", 5200, "과장");
		
		Employee[] empList = {e, e4, e5};
//		Maneger01 m = new Maneger01("나최고", 9000, "부장", empList);
//		Maneger02 m = new Maneger02("나최고", 9000, "부장", empList);
		Maneger03 m = new Maneger03("나최고", 9000, "부장", empList);
